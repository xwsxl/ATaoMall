...
@interface JD_ScreeningViewController ()<UITextFieldDelegate>
{
...
@implementation JD_ScreeningViewController
...
//    self.upView = view2;
    ...
    UIView *bgView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width-50, [UIScreen mainScreen].bounds.size.height)];
...
- (void)handleSwipes:(UISwipeGestureRecognizer *)sender
{
    ...
    if (sender.direction == UISwipeGestureRecognizerDirectionRight) {
        ...
        if (_delegate && [_delegate respondsToSelector:@selector(determineButtonTouchEvent)]) {
            
            [_delegate determineButtonTouchEvent];
