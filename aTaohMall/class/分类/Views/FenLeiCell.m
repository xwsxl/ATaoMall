...
-(void)loadMyCell
{
    ...
    self.LogoImgView = [[UIImageView alloc] initWithFrame:CGRectMake(15, 12, KSWeidth, KSWeidth)];

    self.LogoImgView.layer.borderColor = RGB(225, 225, 225).CGColor;
...
//    [self addSubview:line4];
    ...
    self.NameLabel = [[UILabel alloc] initWithFrame:CGRectMake(KSWeidth+26, 12, [UIScreen mainScreen].bounds.size.width-Width(80)-KSWeidth-26-15, 18)];
    ...
    self.PriceLabel = [[UILabel alloc] initWithFrame:CGRectMake(KSWeidth+26, 10+18+10+15, [UIScreen mainScreen].bounds.size.width-Width(80)-KSWeidth-26, 15)];
    ...
    self.StoreLabel = [[UILabel alloc] initWithFrame:CGRectMake(KSWeidth+26, 12+KSWeidth-12, [UIScreen mainScreen].bounds.size.width-Width(80)-KSWeidth-26, 12)];
    ...
    self.AmountLabel = [[UILabel alloc] initWithFrame:CGRectMake(kScreenWidth-Width(80)-65-15, 12+KSWeidth-12, 65, 12)];
    ...
    UIImageView *fenge = [[UIImageView alloc] initWithFrame:CGRectMake(15, 104, [UIScreen mainScreen].bounds.size.width-Width(80), 1)];
