...
@protocol RecetHomeHeaderDelegate <NSObject>
...
@property(nonatomic, strong)NSArray *list4;//积分商品

@property(nonatomic, strong)NSArray *DPArrM;//积分商品

@property(nonatomic, strong)NSArray *HaoHuoArrM;//积分商品

@property (nonatomic,strong)NSArray *HaoDanArrM;

@property (nonatomic,strong)NSArray *TopBangArrM;
@property (nonatomic,strong)NSArray *ReMenSCArrM;
...
@property (nonatomic,strong)UIView *headerButView;

@property (weak, nonatomic)  NSTimer *timer;


@property(nonatomic,weak) id <RecetHomeHeaderDelegate> delegate;
...
@property (nonatomic,strong)NSString *isShowHQG;

@property (nonatomic,strong)NSString *isShowBigHeathy;

@property (nonatomic,assign)BOOL isShowHomeLittile;
...
@property (nonatomic,strong)NSString *jikeStr;

@property (nonatomic,strong)NSString *jikeSubStr;
