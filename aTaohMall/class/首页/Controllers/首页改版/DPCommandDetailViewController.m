//
//  DPCommandDetailViewController.m
//  aTaohMall
//
...
@interface DPCommandDetailViewController ()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout,DJRefreshDelegate>
{
...
@implementation DPCommandDetailViewController
...
//    });
    ...
    NSDictionary *dict=@{@"id":self.ID,@"page":[NSString stringWithFormat:@"%d",page]};
    
    NSString *url=[NSString stringWithFormat:@"%@brandListToData_mob.shtml",URL_Str];
    ...
    [manager POST:url parameters:dict constructingBodyWithBlock:^(id<AFMultipartFormData>  _Nonnull formData) {
        ...
        if (codeKey && content) {
            ...
            if ([dic[@"status"] isEqualToString:@"10000"]) {
                ...
                self.total_number = [NSString stringWithFormat:@"%@",dic[@"total_number"]];
