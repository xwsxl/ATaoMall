...
-(void)initUI
{
    ...
    self.OneImgView = [[UIImageView alloc] initWithFrame:CGRectMake(([UIScreen mainScreen].bounds.size.width/4-19)/2, 14, 19, 19)];
    self.OneImgView.image = [UIImage imageNamed:@"icon-dianshi"];
    [One addSubview:self.OneImgView];
    
    self.OneTitle =[[UILabel alloc] initWithFrame:CGRectMake(0, 40.5, [UIScreen mainScreen].bounds.size.width/4, 11.5)];
...
//    self.OneTitle.text = @"大家电";
    ...
    self.TwoImgView = [[UIImageView alloc] initWithFrame:CGRectMake(([UIScreen mainScreen].bounds.size.width/4-18.5)/2, 13, 18.5, 20.5)];
    self.TwoImgView.image = [UIImage imageNamed:@"icon-fengshan"];
    [Two addSubview:self.TwoImgView];
    
    self.TwoTitle =[[UILabel alloc] initWithFrame:CGRectMake(0, 40.5, [UIScreen mainScreen].bounds.size.width/4, 11.5)];
...
//    self.TwoTitle.text = @"生活电器";
    ...
    self.ThreeImgView = [[UIImageView alloc] initWithFrame:CGRectMake(([UIScreen mainScreen].bounds.size.width/4-20)/2, 13, 20, 20)];
    self.ThreeImgView.image = [UIImage imageNamed:@"icon-chufang"];
    [Three addSubview:self.ThreeImgView];
    
    self.ThreeTitle =[[UILabel alloc] initWithFrame:CGRectMake(0, 40.5, [UIScreen mainScreen].bounds.size.width/4, 11.5)];
...
//    self.ThreeTitle.text = @"厨房电器";
    ...
    self.FourImgView = [[UIImageView alloc] initWithFrame:CGRectMake(([UIScreen mainScreen].bounds.size.width/4-22)/2, 12.5, 22, 22)];
    self.FourImgView.image = [UIImage imageNamed:@"icon-dian-chui-feng"];
    [Four addSubview:self.FourImgView];
    
    self.FourTitle =[[UILabel alloc] initWithFrame:CGRectMake(0, 40.5, [UIScreen mainScreen].bounds.size.width/4, 11.5)];
