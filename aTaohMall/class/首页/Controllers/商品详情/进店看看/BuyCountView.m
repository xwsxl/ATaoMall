...
-(instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        lb = [[UILabel alloc] initWithFrame:CGRectMake(20, 10, 100, 30)];
        lb.text = @"购买数量";
        ...
        bt_add.frame = CGRectMake(self.frame.size.width-40-40, 10,40, 30);
...
//        tf_count = [[UILabel alloc] initWithFrame:CGRectMake(bt_add.frame.origin.x -45, 10, 40, 30)];
//        tf_count.text =@"1";
//        tf_count.textAlignment = NSTextAlignmentCenter;
//        tf_count.font = [UIFont systemFontOfSize:15];
//        tf_count.backgroundColor = [UIColor colorWithRed:240/255.0 green:240/255.0 blue:240/255.0 alpha:1];
...
//        [self addSubview:line];
        ...
        UIImageView *line1 = [[UIImageView alloc] initWithFrame:CGRectMake(10, self.frame.size.height-0.5, self.frame.size.width-40, 0.5)];
