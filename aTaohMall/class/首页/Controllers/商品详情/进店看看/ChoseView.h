...
@property(nonatomic, retain)UIButton *bt_cart;
@property(nonatomic, retain)UIButton *bt_nowbuy;
...
@property(nonatomic,copy) NSString *StockString;//判断库存
...
@property(nonatomic,copy) NSString *Height;//判断属性框的高度
