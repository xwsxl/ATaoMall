...
//            NSLog(@">>>.model===%@",model.smallName);
//            NSString *str = [arr objectAtIndex:i] ;
            
            NSString *str=model.smallName;
...
//            btn.tag = 100+i;
            ...
            btn.tag = 100+[model.mallId integerValue];
...
//        line.backgroundColor = [UIColor colorWithRed:226/255.0 green:226/255.0 blue:226/255.0 alpha:1.0];
//        [self addSubview:line];
        
        
        UIImageView *line = [[UIImageView alloc] initWithFrame:CGRectMake(10, upY+10, self.frame.size.width-20, 0.5)];
