//
//  HomeLittleAppliancesVC.m
//  aTaohMall
//
//  Created by DingDing on 2017/10/20.
...
@interface HomeLittleAppliancesVC ()<UICollectionViewDelegate,UICollectionViewDataSource>
{
    NSInteger page;
...
@implementation HomeLittleAppliancesVC
...
- (void)loadMoreData {
    ...
    NSDictionary *params=@{@"pageNum":[NSString stringWithFormat:@"%ld",page]};
    [ATHRequestManager requestforGetMoreAppliancesListWithParams:params successBlock:^(NSDictionary *responseObj) {
        totalCount=[[NSString stringWithFormat:@"%@",responseObj[@"totalCount"]] integerValue];
        page++;
         [hud dismiss:YES];
