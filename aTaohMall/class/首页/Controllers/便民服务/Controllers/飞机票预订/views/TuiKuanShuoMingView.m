...
@end
@implementation TuiKuanShuoMingView
...
-(void)setText:(NSString *)Text
{
    ...
    _shareListView = [[UIView alloc]initWithFrame:CGRectMake(0, 0, UIBounds.size.width-30, textSize.height+70)];
    ...
    UIView *selectView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, UIBounds.size.width-30, textSize.height+70)];
    ...
    UILabel *label1 = [[UILabel alloc] initWithFrame:CGRectMake(15, 50, textSize.width, textSize.height)];
...
- (void)showInView:(UIView *) view Text:(NSString *)text{
    ...
    if (self.isHidden) {
        ...
        UIFont *font = [UIFont fontWithName:@"PingFang-SC-Light" size:12];
        CGSize textSize = [text boundingRectWithSize:CGSizeMake(UIBounds.size.width-30-30, 336-50) options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName : font} context:nil].size;
        
//        self.frame = CGRectMake(15,(UIBounds.size.height - 336)/2, UIBounds.size.width-30, 336);
        
        self.frame = CGRectMake(15,(UIBounds.size.height - textSize.height - 50)/2, UIBounds.size.width-30, textSize.height+70);
