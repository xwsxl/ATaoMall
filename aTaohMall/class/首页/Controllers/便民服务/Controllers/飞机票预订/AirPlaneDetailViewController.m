//
//  AirPlaneDetailViewController.m
//  aTaohMall
//
...
#import "AirPlaneBackViewController.h"//返回列表
@interface AirPlaneDetailViewController ()<UIAlertViewDelegate,LoginMessageDelegate>
{
...
@implementation AirPlaneDetailViewController
            ...
            if ([dic[@"status"] isEqualToString:@"10000"]) {
               ...
               isChild=[NSString stringWithFormat:@"%@",dic[@"isChild"]];
                ...
                for (NSDictionary *dict in dic[@"list1"]) {
                    ...
                    BianMinModel *model = [[BianMinModel alloc] init];
//                    {"AirLineCode":"MU","Cabin":"R","CabinName":"经济舱","Discount":"54","IsTeHui":0,"Fare":"670","IsSpe":"1","IsSpePolicy":"0","Sale":"670","TicketCount":"10","TuiGaiQian":"\n以航空公司审核为准","UserRate":"0","BabySalePrice":"130","VTWorteTime":"","WorkTime":"","YouHui":"0","Bookpara":"FAE728EEE207A887231B7EF27BFA02E96B15465997FD1A198DB0D562DE91DC3D5084E8949CE5B7F6DF6356D58429F615FE6B49AA
...
-(void)initNoView
{
    ...
    NoImgView = [[UIImageView alloc] initWithFrame:CGRectMake(([UIScreen mainScreen].bounds.size.width-87)/2, 0, 87, 81)];
    NoImgView.image = [UIImage imageNamed:@"icon-seat"];
    [NoView addSubview:NoImgView];
    
    NoLabel = [[UILabel alloc] initWithFrame:CGRectMake(50, 91, [UIScreen mainScreen].bounds.size.width-100, 15)];
