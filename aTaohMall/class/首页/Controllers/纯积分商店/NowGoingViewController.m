...
#import "NowGoingViewController.h"
...
static NSString *reusedCellID = @"MyCell";

@interface NowGoingViewController ()<UITableViewDataSource,UITableViewDelegate,DJRefreshDelegate,FooterViewDelegate>
{
...
@implementation NowGoingViewController
...
-(void)getDatas
{
    ...
    NSDictionary *dic = @{@"status":@"4",@"type":self.type,@"page":[NSString stringWithFormat:@"%d",page],@"currentPageNo":[NSString stringWithFormat:@"%d",currentPageNo]};
...
-(void)initTableView
{
    ...
    [_tableView registerNib:[UINib nibWithNibName:@"NowLimitCell" bundle:nil] forCellReuseIdentifier:@"cell1"];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (_datasArrM.count==0) {
        ...
        ChunJIFenNoCell *cell=[tableView dequeueReusableCellWithIdentifier:@"noCell"];
        
        cell.selectionStyle = UITableViewCellSelectionStyleNone;
        return cell;
    }else{
        
//        static NSString *reusedCellID1 = @"MyCell2";
        ...
        NowLimitCell *cell=[tableView dequeueReusableCellWithIdentifier:@"cell1"];
...
//        NSDate *end=[dateFormatter dateFromString:cell.endString];
...
//            cell.TimeLabel.hidden=YES;
            cell.HouTingZhiLabel.hidden=YES;
            
            
            cell.TimeLabel.text=@"已停止抢购";
            
            UILabel *newLabel1=[[UILabel alloc] initWithFrame:CGRectMake(15, 45, 105, 20)];
            newLabel1.text=@"已停止抢购";
            newLabel1.textAlignment=NSTextAlignmentCenter;
            newLabel1.textColor=[UIColor whiteColor];
            newLabel1.font=[UIFont systemFontOfSize:13];
