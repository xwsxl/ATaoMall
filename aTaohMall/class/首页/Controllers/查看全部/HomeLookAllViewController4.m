...
@interface HomeLookAllViewController4 ()<UITableViewDataSource,UITableViewDelegate,DJRefreshDelegate,FooterViewDelegate>
{
...
@implementation HomeLookAllViewController4
...
//    [_datas removeAllObjects];
    ...
    NSDictionary *dic = @{@"classId":self.classId,@"type":self.type,@"page":[NSString stringWithFormat:@"%d",page],@"currentPageNo":[NSString stringWithFormat:@"%d",currentPageNo]};
