...
@interface HomeLookAllViewController2 ()<UITableViewDataSource,UITableViewDelegate,DJRefreshDelegate,FooterViewDelegate>
{
...
@implementation HomeLookAllViewController2
    ...
    [manager POST:url parameters:dic success:^(AFHTTPRequestOperation *operation, id responseObject) {
        ...
        if (codeKey && content) {
            ...
            for (NSDictionary *dict1 in dic) {
                ...
                if ([dict1[@"status"] isEqualToString:@"10005"]) {
                    
                    [JRToast showWithText:@"暂无更多数据!" duration:2.0f];
                }
...
//        footer.moreView.hidden=YES;
//        [footer.loadMoreBtn setTitle:@"暂无更多数据" forState:0];
//        [footer.loadMoreBtn setTitleColor:[UIColor colorWithRed:111/255.0 green:111/255.0 blue:111/255.0 alpha:1.0] forState:0];
//        footer.loadMoreBtn.enabled=NO;
...
//    NSString *string2=[NSString stringWithFormat:@"%ld",(unsigned long)_datas.count];
//    
//    
//    NSLog(@"======string10======%@",string10);
//    NSLog(@"======string2======%@",string2);
//    
//    if ([string2 isEqualToString:string10]) {
//        
//        NSLog(@"暂无更多数据！");
//        
//    }else{
