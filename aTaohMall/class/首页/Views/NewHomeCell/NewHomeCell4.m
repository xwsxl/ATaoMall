...
//
//    self.TypeImgView.image = [UIImage imageNamed:@"猜你喜欢111"];
//
//    [self addSubview:self.TypeImgView];
    ...
    self.NameLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 10, kScreenWidth, 40)];

    self.NameLabel.text = @"最近新品";
