...
- (id)initWithText:(NSString *)text{
    if (self = [super init]) {
        ...
        UILabel *textLabel = [[UILabel alloc] initWithFrame:CGRectMake(30, 30, textSize.width + 12, textSize.height + 12)];
        ...
        _contentView = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, textLabel.frame.size.width+60, textLabel.frame.size.height+60)];
