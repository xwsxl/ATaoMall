...
@interface ChangeGoodsAddressViewController ()<STPickerAreaDelegate>
{
...
- (void)viewDidLoad {
    ...
    if ([self.MoRen isEqualToString:@"1"]) {
        [self.SettingSwitch setOn:YES animated:NO];
    }
    //获取数据
    [self getDatas];
                        ...
                        if (self.AddressLabel.text.length == 0) {
                            ...
                            if (self.DetailTextField.text.length == 0) {
                                ...
                                if (!isMatch1) {
                                    ...
                                    NSLog(@"1==%@",self.sigens);
                                    NSLog(@"2==%@",self.NameTextField.text);
                                    NSLog(@"3==%@",self.PhoneTextField.text);
                                    NSLog(@"4==%@",self.province);
                                    NSLog(@"5==%@",self.city);
                                    NSLog(@"6==%@",self.county);
                                    NSLog(@"7==%@",self.DetailTextField.text);
                                    ...
                                    NSDictionary *dic = @{@"sigen":self.sigens,@"id":self.aaid,@"name":self.NameTextField.text,@"phone":self.PhoneTextField.text,@"province":self.province,@"city":self.city,@"county":self.county,@"address":self.DetailTextField.text,@"defaultstate":self.defaultstate};
                                    ...
                                    NSLog(@"%@",self.city);
                                    NSLog(@"%@",self.county);
                                    NSLog(@"%@",self.DetailTextField.text);
                                    NSLog(@"%@",self.defaultstate);
