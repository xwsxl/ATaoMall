...
-(UIToolbar *)setToolbarStyle{
    ...
    UIBarButtonItem *centerSpace0=[[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemFlexibleSpace target:self action:nil];
    ...
    UIBarButtonItem *centerSpace2=[[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemFlexibleSpace target:self action:nil];
    
    toolbar.items=@[centerSpace0,lefttem,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,right,centerSpace2];
    return toolbar;
}
