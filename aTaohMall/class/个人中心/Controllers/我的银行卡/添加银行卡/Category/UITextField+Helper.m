...
+ (NSString *)numberToNormalNumString:(NSString *)textField
{
    
    return [textField stringByReplacingOccurrencesOfString:@"-" withString:@" "];
    
}
+ (NSString *)numberToNormalNumOther:(NSString *)textField
{
