...
@interface NewLoginViewController ()<UITextFieldDelegate,NameAndPassWordDelegate>
{
...
//    if (![userDefaultes stringForKey:@"myArray"] && ![userDefaultes stringForKey:@"password"]) {
        
    
    
//    if ([userDefaultes stringForKey:@"myName"].length==0 || [userDefaultes stringForKey:@"password"].length==0) {
//        
...
//        
//        self.PassWordTF.text=[userDefaultes stringForKey:@"password"];
//    }
//        NSLog(@"====self.UserNameTF.text==>>>>.%@",self.UserNameTF.text);
//        NSLog(@"====self.PassWordTF.text==>>>>.%@",self.PassWordTF.text);
...
- (IBAction)ZhuceBtnClick:(UIButton *)sender {
    ...
    NewZhuCeViewController *vc=[[NewZhuCeViewController alloc] init];
                ...
                if (self.PassWordTF.text.length == 0) {
                    ...
                    if (self.PassWordTF.text.length < 6){
                        ...
                        if([self.PassWordTF.text rangeOfString:@" "].location != NSNotFound){
                            ...
                            [self NewLogin];
//                            //用户名是否为字母加数字
//                            NSString *CM_NUM10 = @"(?!^[0-9]+$)(?!^[A-z]+$)(?!^[^A-z0-9]+$)^.{6,20}$";
//                            NSString *CM_NUM11 = @"(?!^[a-zA-Z]+$)";
//                            NSString *CM_NUM12 = @"(?!^[_#@]+$)";
//                            
//                            NSPredicate *pred110 = [NSPredicate predicateWithFormat:@"SELF MATCHES %@", CM_NUM10];
//                            NSPredicate *pred111 = [NSPredicate predicateWithFormat:@"SELF MATCHES %@", CM_NUM11];
//                            NSPredicate *pred112 = [NSPredicate predicateWithFormat:@"SELF MATCHES %@", CM_NUM12];
//                            
//                            
//                            BOOL isMatch110 = [pred110 evaluateWithObject:self.PassWordTF.text];
//                            BOOL isMatch111 = [pred111 evaluateWithObject:self.PassWordTF.text];
//                            BOOL isMatch112 = [pred112 evaluateWithObject:self.PassWordTF.text];
//                            
//                            NSLog(@"======%ld===",isMatch110);
//                            NSLog(@"======%ld===",isMatch111);
//                            NSLog(@"======%ld===",isMatch112);
