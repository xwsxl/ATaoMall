...
//    、、、、、、、、、、、、、、、、、、、、、、、、、、、、、、、
    CGFloat mainViewHeight = 48 + (1 + 48)*self.buttonTitlesCount;
    ...
    for (int i = 0; i<self.buttonTitlesCount; i++) {
        ...
        UILabel *typeLabel=[[UILabel alloc] initWithFrame:CGRectMake(20, lineView.bottomv+15, 80, 20)];
        typeLabel.text=self.otherButtonTitles[i];
        [mainView addSubview:typeLabel];
        
        UIImageView *imgView=[[UIImageView alloc] initWithFrame:CGRectMake(self.widthv-40, lineView.bottomv+15, 20, 20)];
        imgView.tag=i+1;
        
        
        NSUserDefaults *userDefaultes = [NSUserDefaults standardUserDefaults];
        
        NSLog(@"+++%@++++%ld++",[userDefaultes stringForKey:@"gouxuan"],[userDefaultes stringForKey:@"gouxuan"].length);
        ...
        if ([userDefaultes stringForKey:@"gouxuan"].length==0) {
            ...
            if (imgView.tag==1) {
                ...
                imgView.image=[UIImage imageNamed:@"勾选状态"];
               
                
            }else{
                imgView.image=[UIImage imageNamed:@"wugouxuan.png"];
            ...
            if (imgView.tag==[[userDefaultes stringForKey:@"gouxuan"] integerValue]) {
...
//        [btn setTitle:self.otherButtonTitles[i] forState:UIControlStateNormal];
    ...
    // 添加深灰色分割线
    UIView * grayView = [[UIView alloc] initWithFrame:CGRectMake(0, bottomY, self.widthv, 1)];
...
//    cancelBtn.tag = 1001;
//    cancelBtn.frame = CGRectMake(0, grayView.bottomv+83, self.widthv, 48);
//    
//    cancelBtn.backgroundColor=[UIColor colorWithRed:255/255.0 green:93/255.0 blue:94/255.0 alpha:1.0];
//    
...
-(void)setSelectString:(NSString *)SelectString
{
    ...
    UIImageView *selectImageView1=(UIImageView *)[self viewWithTag:1];
    UIImageView *selectImageView2=(UIImageView *)[self viewWithTag:2];
    
    if ([_SelectString isEqualToString:@"1"]) {
        
        NSLog(@"1111");
        
        selectImageView1.image=[UIImage imageNamed:@"勾选状态"];
    
        selectImageView2.image=[UIImage imageNamed:@"wugouxuan.png"];
            

    }
    
    if ([_SelectString isEqualToString:@"2"]) {
        
        
        NSLog(@"2222");
        
        selectImageView2.image=[UIImage imageNamed:@"勾选状态"];
        
        selectImageView1.image=[UIImage imageNamed:@"wugouxuan.png"];
...
- (void)clickAction:(UIButton *)btn
{
    UIImageView *selectImageView1=(UIImageView *)[self viewWithTag:1];
    UIImageView *selectImageView2=(UIImageView *)[self viewWithTag:2];
    UIImageView *selectImageView3=(UIImageView *)[self viewWithTag:3];
    ...
    if (btn.tag==0) {
        ...
        selectImageView1.image=[UIImage imageNamed:@"勾选状态"];
        selectImageView2.image=[UIImage imageNamed:@"wugouxuan.png"];
        selectImageView3.image=[UIImage imageNamed:@"wugouxuan.png"];
        ...
        selectImageView3.image=[UIImage imageNamed:@"勾选状态"];
        selectImageView2.image=[UIImage imageNamed:@"wugouxuan.png"];
        selectImageView1.image=[UIImage imageNamed:@"wugouxuan.png"];
